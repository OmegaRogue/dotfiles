...
package.path = package.path .. ';'..os.getenv("HOME")..'/.local/lib/python3.10/site-packages/powerline/bindings/awesome/?.lua'
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Left widgets
            ...
            mylauncher,
            statuslinew(s.mytaglist, beautiful.taglist_fg_focus,  beautiful.taglist_bg_focus,    beautiful.taglist_bg_focus,    beautiful.tasklist_bg_focus),
            s.mypromptbox,
        },
