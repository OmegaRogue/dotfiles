...
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = ""
end, text_size = 20, text = "CE" }, 3, 1, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = ""
end, text_size = 20, text = "C" }, 3, 2, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text:sub(1, -2)
end, text_size = 20, text = "\u{f56d}" }, 3, 3, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "/"
end, text_size = 20, text = "\u{f6d3}" }, 3, 4, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "7"
end, text_size = 20, text = "7" }, 4, 1, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "8"
end, text_size = 20, text = "8" }, 4, 2, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "9"
end, text_size = 20, text = "9" }, 4, 3, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "*"
end, text_size = 20, text = "\u{f655}" }, 4, 4, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "4"
end, text_size = 20, text = "4" }, 5, 1, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "5"
end, text_size = 20, text = "5" }, 5, 2, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "6"
end, text_size = 20, text = "6" }, 5, 3, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "-"
end, text_size = 20, text = "\u{f873}" }, 5, 4, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "1"
end, text_size = 20, text = "1" }, 6, 1, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "2"
end, text_size = 20, text = "2" }, 6, 2, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "3"
end, text_size = 20, text = "3" }, 6, 3, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "+"
end, text_size = 20, text = '\u{f914}' }, 6, 4, 1, 1)
test:add_widget_at(awesomebuttons.with_text { text_size = 20, text = "±" }, 7, 1, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "0"
end, text_size = 20, text = "0" }, 7, 2, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
    equation.text = equation.text .. "."
end, text_size = 20, text = "." }, 7, 3, 1, 1)
test:add_widget_at(awesomebuttons.with_text { onclick = function()
...
test:add_widget_at(awesomebuttons.with_icon { icon = "x", onclick = function()
    toggle_calculator()
end }, 1, 4, 1, 1)
