...
--                   '/.local/lib/python3.10/site-packages/powerline/bindings/awesome/?.lua;' .. os.getenv("HOME") .. '/.config/
local set = vim.opt
...
vim.cmd("autocmd filetype nerdtree syn match haskell_icon #?# containedin=NERDTreeFile")
-- if you are using another syn highlight for a given line (e.g.
-- NERDTreeHighlightFile) need to give that name in the 'containedin' for this
-- other highlight to work with it
-- autocmd filetype nerdtree syn match html_icon #?# containedin=NERDTreeFile,html
vim.cmd("autocmd filetype nerdtree syn match go_icon #?# containedin=NERDTreeFile")
